    ...
    <div v-if="libroSeleccionado" class="modal fade show d-block" tabindex="-1" role="dialog" aria-modal="true" @click.self="cerrarDetalle">
      <div class="modal-ys">
        ...
        <div class="modal-cover">
          <img v-if="libroSeleccionado.image" :src="libroSeleccionado.image" :alt="libroSeleccionado.name" @error="e => { e.target.onerror = null; e.target.src = $resolveCover(null, { title: 'Libro', id: 0 }) }" />
